    ...
    <div class="container">
      <div class="col-xs-12 col-md-8">
        <section>
          ...
          <ul>
            <li>
              <a id="change-cookie-disclaimer" href="#change"
                >Datenschutz-Einstellungen ändern</a
              >
            </li>
            <li>
              <a id="revoke-cookie-disclaimer" href="#revoke"
          ...
          <p>
            Simeonidis Konstantinos <br />Corneliusstr. 24 <br />D-80469 München
            <br />Tel.: 0177 6460429 oder Tel.: 01577 2035061 <br />eMail: info (at)
            wingtzun-muenchen.de
          </p>
        ...
        <section>
          ...
          <p>
            Sofern Sie die in unseren Internetauftritt eingebundene Komponente Google Maps
            aufrufen, speichert Google über Ihren Internet-Browser ein Cookie auf Ihrem
            Endgerät. Um unseren Standort anzuzeigen und eine Anfahrtsbeschreibung zu
